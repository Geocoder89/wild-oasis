...
function CheckinBooking() {
  ...
  return (
    <>
      ...
      <Box>
      <Checkbox checked={confirmPaid} id="confirm" onChange={handleConfirmPaid} disabled={confirmPaid || isCheckingIn}>I confirm that {guests.fullName} has paid the total amount of I confirm that {guests.fullName} has paid the total amount of{" "}
      {!addBreakfast
